...
const Signup = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
			const url = "http://192.168.9.239:8000/api/users";
  ...
  return (
    <>
        <div className="w-full max-w-sm px-8 pb-8 mx-auto my-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4" style={{marginTop:"10vh"}}>
            <div className="flex justify-center gap-4 mb-8" style={{marginBottom:"30px", marginTop:"20px"}}>
                <Link to="/login" className="bg-blue-600 hover:bg-blue-600 px-4 text-white font-semibold py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">Login</Link>
                <Link to="/signup" className="bg-gray-500 hover:bg-gray-600 px-4 text-white font-semibold py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400">Signup</Link>
            </div>
            ...
            <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
                ...
                <div className="relative">
                    ...
                    <input type="email" name="email" style={{paddingLeft:"30px"}}
                                    onChange={handleChange}
                                    value={data.email}
